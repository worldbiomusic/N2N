...
/**
 * A handler to get a broadcast message sent from a node.
 * <p>
 * Data format: [id] [message]+
 */
public class BroadcastMessaengerHandler implements Handler {
    @Override
    public void handle(Connection connection, Message msg) {
        ...
        System.out.println("Broadcast message arrived from the node(" + id + ")");
        System.out.println(message);
    }

    @Override
    public String getName() {
        return MessengerMsgType.BMSG.name();
    }
}
